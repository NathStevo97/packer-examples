...
#                           VMware-ISO Builder                  #
#################################################################
source "vmware-iso" "vmware-win2019-datacenter" {
...
#################################################################
source "hyperv-iso" "hv1-win2019-datacenter" {
  communicator         = "winrm"
  cpus                 = "${var.numvcpus}"
  disk_size            = "${var.disk_size}"
  floppy_files         = ["./Files/bios/win2019/DC/autounattend.xml", "./Files/scripts/winrmConfig.ps1"]
...
build {
  ...
  provisioner "powershell" {
    ...
    only              = ["vmware-iso.win2019-datacenter"] # this provisioner will only run for the vmware-iso build
