...
#                           VMware-ISO Builder                  #
#################################################################
source "vmware-iso" "vmware-win2022-datacenter" {
...
#################################################################
source "hyperv-iso" "hv1-win2022-datacenter" {
  communicator         = "winrm"
  cpus                 = "${var.numvcpus}"
  disk_size            = "${var.disk_size}"
  floppy_files         = ["./Files/bios/win2022/dc/autounattend.xml", "./Files/scripts/winrmConfig.ps1"]
...
#################################################################
source "hyperv-iso" "hv2-win2022-datacenter" {
...
source "virtualbox-iso" "vbox-win2022-datacenter" {
  communicator         = "winrm"
  disk_size            = 61440
  floppy_files         = ["./Files/bios/win2022/dc/autounattend.xml", "./Files/scripts/winrmConfig.ps1"]
  guest_additions_mode = "disable"
...
build {
  sources = ["source.vmware-iso.vmware-win2022-datacenter", "source.hyperv-iso.hv1-win2022-datacenter", "source.hyperv-iso.hv2-win2022-datacenter", "source.virtualbox-iso.vbox-win2022-datacenter"]


  provisioner "powershell" {
    elevated_password = "packer"
    elevated_user     = "Administrator"
    only              = ["vmware-iso.win2022-datacenter"] # this provisioner will only run for the vmware-iso build
