...
disk_size                = "61440"
floppy_files             = ["./Files/bios/win10/autounattend.xml", "./Files/scripts/update-windows.ps1", "./Files/scripts/configure-winrm.ps1", "Files/scripts/winrmConfig.ps1"]
...
secondary_iso_image      = "./Files/bios/win10/secondary.iso"
