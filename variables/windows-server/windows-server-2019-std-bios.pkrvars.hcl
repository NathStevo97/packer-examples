...
efi_boot                 = false
firmware                 = "bios"
floppy_files             = ["./templates/files/windows/server-2019/std/bios/Autounattend.xml"]
...
secondary_iso_image      = "./templates/files/windows/server-2019/std/secondary.iso"
switch_name              = "Default Switch" # change this to whatever your switch is! Look in Hyper-V Manager to find it!
upgrade_timeout          = ""
vlan_id                  = ""
vm_name                  = "windows2019-std-bios"
