...
disk_size                = "40960"
floppy_files             = ["./templates/files/windows/win2019/std/autounattend.xml", "./templates/files/windows/scripts/winrmConfig.ps1"]
...
memsize                  = "2048"
numvcpus                 = "2"
output_directory         = "./builds/output-windows-2019-STD"
secondary_iso_image      = "./templates/files/windows/win2019/std/secondary.iso"
