...
efi_boot                 = true
firmware                 = "efi"
floppy_files             = ["./templates/files/windows/server-2022/uefi/std/Autounattend.xml", "./templates/files/windows/scripts/winrmConfig.ps1"]
...
secondary_iso_image      = "./templates/files/windows/win2022/std/secondary.iso"
switch_name              = "Default Switch"
upgrade_timeout          = ""
vlan_id                  = ""
vm_name                  = "Win2022_standard_uefi"
