...
disk_size                = "61440"
floppy_files             = ["./templates/files/windows/11/uefi/autounattend.xml", "./templates/files/windows/scripts/configure-winrm.ps1"]
...
secondary_iso_images     = "./templates/files/windows/bios/win11/uefi/secondary.iso"
